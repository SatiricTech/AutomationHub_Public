# Step 1: Upgrade Windows 11 Home to Pro
...
Write-Host ""
Write-Host "This script will upgrade Windows 11 Home/Core to Pro." -ForegroundColor White
Write-Host "The upgrade process will begin automatically." -ForegroundColor White
Write-Host ""
...
try {
    ...
    Write-Host "================================================" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "Your computer needs to REBOOT to complete the upgrade." -ForegroundColor Yellow
    Write-Host ""
    ...
    $rebootConfirm = Read-Host "Press ENTER to reboot now (or Ctrl+C to cancel)"
